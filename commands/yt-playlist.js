...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (!text) {
                citel.reply(`﹍﹉﹍﹉﹍﹉﹍කවි ඉසු﹍﹉﹍﹉﹍     ﹉                                                                                                                                                                                                                                                                                                                       ♦ ┆ සිංදු ලබ ගැනිනට                                                   🌀 (.𝐬𝐨𝐧𝐠 / .𝐢𝐬𝐮)                                                                                                                                          යන ලෙස ටයිප් කර ඔබට අවශ්‍ය සිංදුවෙ නම එවන්න                                            උද? (.𝐬𝐨𝐧𝐠 𝐥𝐞𝐥𝐞𝐧𝐚 / .𝐢𝐬𝐮 𝐥𝐞𝐥𝐞𝐧𝐚)                                                                                                                             ♦ ┆ විඩියෝ ලබ ගැනිමට                                                 🌀 (.𝐯𝐢𝐝𝐞𝐨)                                                             යන ලෙස ටයිප් කර ඔබට අවශ්‍ය සිංදුවෙ නම එවන්න                                        උද? (.𝐯𝐢𝐝𝐞𝐨 𝐥𝐞𝐥𝐞𝐧𝐚)  Please provide me a url`);
                return;
            }
